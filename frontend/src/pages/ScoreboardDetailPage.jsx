...
import { Plus, Minus, Share2, Trash2, Copy, Check, RotateCcw, Settings, Trophy, ArrowUpDown } from 'lucide-react'
      ...
      <Card className="bg-gradient-to-r from-green-50 to-emerald-50 border-green-200">
        <CardContent className="flex flex-col sm:flex-row items-center justify-between py-4 gap-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-sm font-medium text-slate-700">Share this scoreboard</p>
              ...
              <div className="flex flex-col lg:flex-row">
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <h3 className="text-xl font-bold text-slate-900 truncate">{player.name}</h3>
                    {sortOrder !== 'none' && (
                ...
                {/* Score Controls */}
                <div className="bg-slate-50 p-4 flex flex-col gap-3 lg:w-80">
